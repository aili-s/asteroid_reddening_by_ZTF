...
For own project, this method was applied to more than 150 objects to calculate the slope of the spectra within the families. For this purpose, three families were selected: Massalia, Eunomia and Carin (CoronisII).
